...
function validateCreateRequest(req, res, next) {
    if(!req.body.name) {
        ErrorResponse.message = 'Something went name wrong while creating airport';
    ...
    if(!req.body.code) {
        ErrorResponse.message = 'Something went a wrong while creating airport';
    ...
    if(!req.body.cityId) {
        ErrorResponse.message = 'Something went b wrong while creating airport';
